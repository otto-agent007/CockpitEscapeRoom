...
- Final Vercel preview: `https://cockpit-escape-room-3l9bqa4wd-ottoagent007-gmailcoms-projects.vercel.app` (`dpl_HqH9iEh14ZqqNeArL6EVVifRHsZE`). Authenticated HTTP/2 checks returned 200 and `model/gltf-binary`; the deployed 44,288,740-byte model and loader cache key match the validated local build.
