...
EXPECTED_APPROVAL = {
    "approvalId": "dc9-memphis-legacy-assembly-approval-001",
    "jobId": "dc9-memphis-legacy-assembly",
    "sourceJobId": "dc9-memphis-legacy-source",
    "stage": "assembly-approved",
    "approved": True,
    "approvedBy": "owner review 2026-08-28",
    "assemblyManifest": "art-source/cockpit-pipeline/jobs/dc9-memphis-legacy-assembly/manifests/assembly-complete.json",
    "assemblyManifestSha256": "83f16a2c9efdace15006d74eabe022753e5e0ff5ba008701cac340f88c920648",
}
EXPECTED_APPROVED_ARTIFACTS = {
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/dc9-memphis-legacy-neutral.blend": "393ba3b742578fe223b9853fb3ed4ff50c802d69c801e38d7e5688551ee22032",
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/dc9-memphis-legacy-neutral.glb": "92820c6daa5f8d31dd2518f9ff3e4002167c5da83504e052f3d9b0c36cd57471",
    ...
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/resolved-layout.json": "3a3f0a67b10c5f736047807ebdaf43f92db72e3e6f395692b1e56fea744c1ac5",
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/node-pivot-report.json": "149ba8c4d551dcb5633c66614fff3d0546698b2d6eef91923c2be6157aca19d5",
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/previews/neutral-1440.png": "b171873f16554e1d194442e1521dcf18df27d7cbd47248922a88f3f273f7158e",
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/previews/neutral-768.png": "6abfc57f980121ee81906ac7681aecf2b6b99f008159a67c33b54916f8dfa310",
    "art-source/cockpit-pipeline/stages/assembly/output/dc9-memphis-legacy-assembly/previews/neutral-375.png": "96a3abf185c6c81cc6c03ba7a34f08fdef5a62ebbd24f5b4245d66b3cebecfe9",
}
SOURCE_HASHES = {
...
RESTORED_SHADED_BLEND_SHA256 = "4e8cc6cc6a7a3dcef71f1f4579efda4c2a17f49e2dee7ee62db9c818ed487d3d"
RESTORED_SHADED_GLB_SHA256 = "73b80e6f388b15c853b1ec39b6af6a31b36da040d447f7a6cc916ea7924d346b"
...
def validate_shaded_master(bpy: Any) -> dict[str, Any]:
    ...
    if len(current_contract) != 25 or mesh_count != 15 or triangle_count != 376 or len(material_names) != 5:
...
def main() -> int:
    ...
    if validation["triangleCount"] != 376:
        raise ValueError(f"approved triangle count changed: {validation['triangleCount']} != 376")
