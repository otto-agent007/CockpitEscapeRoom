...
SHADING_COMPLETE = "shading_complete"
SHADING_APPROVED = "shading-approved"
REJECTED = "rejected"

STAGES = {REQUESTED, SOURCING_COMPLETE, SOURCE_APPROVED, ASSEMBLY_COMPLETE, ASSEMBLY_APPROVED, SHADING_COMPLETE, SHADING_APPROVED, REJECTED}
...
ALLOWED_TRANSITIONS = {
    ...
    ASSEMBLY_APPROVED: {SHADING_COMPLETE, SHADING_APPROVED, REJECTED},
    SHADING_COMPLETE: {SHADING_APPROVED, REJECTED},
