...
try {
  for (const scenario of [
    ...
    await page.waitForFunction(text => document.querySelector('#asset-status').textContent.includes(text), missing ? (defender === 'oracle' ? '50/51 sprites ready; 1 failed' : '49/51 sprites ready; 2 failed') : '51/51 sprites ready')
