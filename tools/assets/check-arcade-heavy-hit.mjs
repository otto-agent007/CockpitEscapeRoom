...
try {
  for (const scenario of [
    ...
    await page.waitForFunction(text => document.querySelector('#asset-status').textContent.includes(text), missing ? (defender === 'oracle' ? '67/68 sprites ready; 1 failed' : '66/68 sprites ready; 2 failed') : '68/68 sprites ready')
