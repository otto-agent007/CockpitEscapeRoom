...
try {
  for (const scenario of [
    ...
    await page.waitForFunction(text => document.querySelector('#asset-status').textContent.includes(text), missing ? (defender === 'oracle' ? '48/49 sprites ready; 1 failed' : '47/49 sprites ready; 2 failed') : '49/49 sprites ready')
