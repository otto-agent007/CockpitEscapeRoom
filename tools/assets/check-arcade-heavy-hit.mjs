...
try {
  for (const scenario of [
    ...
    await page.waitForFunction(text => document.querySelector('#asset-status').textContent.includes(text), missing ? (defender === 'oracle' ? '45/46 sprites ready; 1 failed' : '44/46 sprites ready; 2 failed') : '46/46 sprites ready')
