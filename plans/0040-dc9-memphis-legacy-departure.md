...
**Terminal-composition re-assembly — 2026-08-28 (Assembly Review Gate pending):** On `asset/dc9-memphis-terminal-composition`, Agent 2 re-ran with the west-frontage layout, the route-over-void ground fix, and six new windshield-pose previews (`windshield-ramp-start-{1440,768,375}`, `windshield-hold-short-1440`, `windshield-runway-lineup-1440`, `windshield-takeoff-roll-1440`). RED was captured first (new layout tests failed against the retired module), then 21 pipeline tests, gate/manifest validation with verified hashes, and clean GLB validation passed. New neutral GLB SHA-256 `f8324888f3a3a385b9a9a66935f57a37c04cf3f1e72f6f19f9f3bcbe2ea9092f`, blend `44c31fa052ce01e77b5ab9b28381d40f8e362c403069afe40e0892313d5f2383`. The prior approval below covered the retired east-side composition; a fresh owner Assembly Review Gate decision is required before the shading re-run (which must also assign the ramp material to `KMEM_TERMINAL_APRON`).
